...
def pos_encoding_attention_ex():
    ...
    plt.ylabel("Position")
    plt.colorbar()
    plt.savefig("images/01-01", dpi=300)
    ...
    ic(temp_attn)  # 어텐션 분포(어텐션 가중치의 나열)
    ic(temp_out)  # 어텐션 값
...
if __name__ == "__main__":
    ...
    #     small_transformer, to_file="images/01_small_transformer.png", show_shapes=True
    # )
    ...
    #
    # print(predict("영화 볼래?"))
    # print(predict("고민이 있어"))
    # print(predict("너무 화가나"))
    # print(predict("게임하고싶은데 할래?"))
    # print(predict("나 너 좋아하는 것 같아"))
    # print(predict("딥 러닝 자연어 처리를 잘 하고 싶어"))
