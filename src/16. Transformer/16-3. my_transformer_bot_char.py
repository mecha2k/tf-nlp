...
from my_sent_tokenizer import char_vectorization
...
(train_ds, valid_ds, test_pairs, vocab_size, max_len) = char_vectorization(batch_size=batch_size)
...
plot_model(transformer, "images/my_transformer_bot_char.png", show_shapes=True)
transformer.summary()
...
callbacks = [keras.callbacks.ModelCheckpoint("../data/my_transformer_bot.char")]
transformer.fit(train_ds, epochs=epochs, validation_data=valid_ds, callbacks=callbacks)

transformer = keras.models.load_model(
    "../data/my_transformer_bot.char",
    custom_objects={
