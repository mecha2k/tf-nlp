...
def bleu_score(candidate, reference_list, weights=[0.25, 0.25, 0.25, 0.25]):
    ...
    p_n = [
        modified_precision(candidate, reference_list, n=n) for n, _ in enumerate(weights, start=1)
    ]
    # p1, p2, p3, ..., pn
...
print(
    "실습 코드의 BLEU :", bleu_score(candidate.split(), list(map(lambda ref: ref.split(), references)))
)
print(
    "패키지 NLTK의 BLEU :",
