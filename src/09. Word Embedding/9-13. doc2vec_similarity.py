...
# tagged_corpus_list = np.array(tagged_corpus_list, dtype=object)
# np.save("../data/tagged_corpus_list", tagged_corpus_list)

tagged_corpus_list = np.load("../data/tagged_corpus_list.npy", allow_pickle=True)
